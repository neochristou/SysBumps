...
void gen_eset(size_t addr, void **eset_stlb, void **eset_dtlb, size_t base_offset);
void gen_eset_pc(size_t addr, void **eset_stlb, void **eset_dtlb, size_t base_offset);
void prime(void **eset_stbl);
